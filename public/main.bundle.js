...
var LogService = (function () {
    ...
    LogService.prototype.registerUser = function (user) {
        ...
        return this.http.post(this.source + this.address + '/cUser', user, { headers: headers })
    ...
    LogService.prototype.authenticateUser = function (user) {
        ...
        return this.http.post(this.source + this.address + '/authUser', user, { headers: headers })
            .map(function (res) { return res.json(); });
    };
    LogService.prototype.getProfile = function () {
        ...
        headers.append('Content-Type', 'application/json');
        return this.http.get(this.source + this.address + '/gUser', { headers: headers })
            .map(function (res) { return res.json(); });
    };
...
var ShopService = (function () {
    ...
    ShopService.prototype.gCart = function () {
        ...
        headers.append('Content-Type', 'application/json');
        return this.http.get(this.source + this.address + '/gCart', { headers: headers })
            .map(function (res) { return res.json(); });
    };
    //Store user cart
    ShopService.prototype.uCart = function () {
        ...
        headers.append('Authorization', authToken);
        headers.append('Content-Type', 'application/json');
        return this.http.post(this.source + this.address + '/uCart', body, { headers: headers })
            .map(function (res) { return res.json(); });
    };
    //Store user cart
    ShopService.prototype.dCart = function () {
        ...
        headers.append('Authorization', authToken);
        headers.append('Content-Type', 'application/json');
        return this.http.get(this.source + this.address + '/dCart', { headers: headers })
            .map(function (res) { return res.json(); });
    };
    //Store user cart
    ShopService.prototype.cCart = function () {
        ...
        headers.append('Authorization', authToken);
        headers.append('Content-Type', 'application/json');
        return this.http.post(this.source + this.address + '/cCart', body, { headers: headers })
            .map(function (res) { return res.json(); });
    };
...
var PayService = (function () {
    ...
    PayService.prototype.stripeCharge = function (payment, uLogged) {
        ...
        headers.append('Content-Type', 'application/json');
        return this.http.post(this.source + this.address + '/cCharge', body, { headers: headers })
            .map(function (res) { return res.json(); });
    };
    PayService.prototype.stripeRetrieve = function (chargeId, uLogged) {
        ...
        headers.append('Content-Type', 'application/json');
        return this.http.post(this.source + this.address + '/rCharge', body, { headers: headers })
            .map(function (res) { return res.json(); });
    };
...
var StoreComponent = (function () {
    ...
    StoreComponent.prototype.ngOnInit = function () {
        ...
        this.sProducts = [{
                ...
                pImgs: ['../../../../assets/images/deodorant']
            }, {
                pName: 'Soap',
                pPrice: 8,
                pDes: 'Clean up and smells good',
                pImgs: ['../../../../assets/images/soap']
            }, {
                pName: 'Shave',
                pPrice: 7,
                pDes: 'Safe and sound',
                pImgs: ['../../../../assets/images/shave']
            }, {
                pName: 'After Shave',
                pPrice: 5,
                pDes: 'Healty lotion',
                pImgs: ['../../../../assets/images/afterShave']
            }, {
                pName: 'Wet Towels',
                pPrice: 4,
                pDes: 'Be fresh everywhere, everytime',
                pImgs: ['../../../../assets/images/towel']
            }];
    };
...
var PManagementService = (function () {
    ...
    PManagementService.prototype.gProducts = function () {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.get(this.source + this.address + '/gProducts', { headers: headers })
            .map(function (res) { return res.json(); });
    };
    //Store user cart
    PManagementService.prototype.uProduct = function (product) {
        ...
        headers.append('Authorization', authToken);
        headers.append('Content-Type', 'application/json');
        return this.http.post(this.source + this.address + '/uProduct', body, { headers: headers })
            .map(function (res) { return res.json(); });
    };
    //Store user cart
    PManagementService.prototype.dProduct = function (product) {
        ...
        headers.append('Authorization', authToken);
        headers.append('Content-Type', 'application/json');
        return this.http.post(this.source + this.address + '/dProduct', body, { headers: headers })
            .map(function (res) { return res.json(); });
    };
    //Store user cart
    PManagementService.prototype.cProduct = function (product) {
        ...
        headers.append('Authorization', authToken);
        headers.append('Content-Type', 'application/json');
        return this.http.post(this.source + this.address + '/cProduct', body, { headers: headers })
            .map(function (res) { return res.json(); });
    };
